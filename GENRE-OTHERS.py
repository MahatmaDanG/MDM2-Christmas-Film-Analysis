# -*- coding: utf-8 -*-
"""
Created on Mon Feb  6 04:29:36 2023
...
df_main = df.loc[:,['imdb_rating','Main_Genre']]
df_main_grouped = df_main.groupby(['Main_Genre'])
df_fr = pd.DataFrame(index=[])

for name, group in df_main_grouped :
    if name == 'Comedy' :
...
df_main_grouped_2 = df_fr.groupby(['Main_Genre'])
