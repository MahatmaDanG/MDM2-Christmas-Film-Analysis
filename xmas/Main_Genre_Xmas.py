# -*- coding: utf-8 -*-
"""
Created on Wed Feb 15 17:19:36 2023
...
for name, group in df_grouped :
    ...
    r = group['bins'] = pd.cut(x=group['Worldwide_Net_Revenue'], bins=[-40000000, 0, 60000000, 110000000, 10000000000])
    fr_r = r.value_counts()
    fr_r = fr_r.rename(name)
    df_fr=df_fr.append(fr_r)
#60000000 is the average of all the films, 110000000 is the average of the selected films
...
plt.bar(x,y3,width=0.4,bottom=y1,label='(60000000, 110000000]',color='#00bfc4',zorder=5)
plt.bar(x,y4,width=0.4,bottom=y1,label='(110000000, 10000000000]',color='#f9766e',zorder=5)
